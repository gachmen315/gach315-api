...
namespace ElectronicShop.Services.Interfaces
{
    public interface IAPIServices
    {
        ...
        Task<CmsLoginRes> CreateToken(Users user);
        ...
        Task<RefreshTokenRes?> RenewToken(RefreshTokenReq model, string AccessToken);
        ...
        Task<int> DeleteProduct(int id, string user);
